...
export const AccountsRisingHoverCard = ({ companyName = 'Neary Brands' }: { companyName?: string }) => {
  return (
    <div className="absolute z-50 flex flex-col items-start p-0 w-[434px] bg-white shadow-[0px_1px_2px_rgba(0,0,0,0.3),0px_1px_3px_1px_rgba(0,0,0,0.15)] rounded-[8px] top-full left-1/2 -translate-x-1/2 mt-2 cursor-default no-underline text-left">
      {/* Header */}
      ...
      <div className="flex flex-row items-start p-0 w-full h-[168px] bg-white shadow-[inset_0px_-1px_0px_#DADCE0] rounded-b-[8px]">
        ...
        {/* Column 1: Accounts */}
        <div className="flex flex-col justify-start items-start p-0 w-[198px] h-full bg-white rounded-bl-[8px]">
          ...
          <div className="flex flex-col items-start p-[4px_16px] w-full h-[44px]">
            <div className="flex flex-row items-start p-0 gap-[4px] rounded-[16px]">
              ...
              <div className="flex flex-col justify-center items-start p-0">
                <div className="font-['Google_Sans_Text'] font-normal text-[13px] leading-[20px] tracking-[0.2px] text-[#202124] truncate w-[139px]">
                  Neary Brands Store UK
                </div>
        ...
        <div className="flex flex-col justify-start items-end p-0 w-[63px] h-full bg-white">
          ...
          <div className="flex flex-col justify-center items-end p-[4px_8px] w-full h-[44px]">
            ...
            <div className="font-['Google_Sans_Text'] font-normal text-[12px] leading-[16px] tracking-[0.1px] text-[#188038]">
              +1.2%
            </div>
          </div>
          <div className="flex flex-row items-center py-[2px] px-0 w-full h-[4px]">

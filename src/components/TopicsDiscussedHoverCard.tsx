...
export const TopicsDiscussedHoverCard = ({ companyName = 'Neary Brands', topicTitle = '3 topics discussed' }: { companyName?: string, topicTitle?: string }) => {
  return (
    <div className="absolute z-50 flex flex-col items-start p-0 w-[369px] bg-white shadow-[0px_1px_2px_rgba(0,0,0,0.3),0px_1px_3px_1px_rgba(0,0,0,0.15)] rounded-[8px] top-full left-1/2 -translate-x-1/2 mt-2 cursor-default no-underline text-left">
      ...
      {/* Content */}
      <div className="flex flex-col items-start p-[12px_16px] gap-[8px] w-full bg-white rounded-b-[8px]">
        <div className="flex flex-row items-center p-0 gap-[2px] w-full h-[20px]">
        ...
        <div className="flex flex-col items-start p-0 gap-[8px] w-full">
          <div className="flex items-start">
            ...
            <div className="font-['Google_Sans_Text'] font-normal text-[14px] leading-[20px] text-[#1B1B1C]">
              <span className="font-medium">Steering the "AI Co-Pilot" (Agentic AI):</span> Utilizing the new Ads Advisor (Agentic AI) to identify "pockets of profit" across their different sub-brands.
            </div>
          </div>
          ...
          <div className="flex items-start">
            <span className="mr-2 mt-2 w-1 h-1 bg-[#1B1B1C] rounded-full flex-shrink-0"></span>
            <div className="font-['Google_Sans_Text'] font-normal text-[14px] leading-[20px] text-[#1B1B1C]">
              <span className="font-medium">Optimizing for "AI Overviews":</span> Increase visibility within AI Overviews and AI Mode.
            </div>
          </div>
          ...
          <div className="flex items-start">
            <span className="mr-2 mt-2 w-1 h-1 bg-[#1B1B1C] rounded-full flex-shrink-0"></span>
            <div className="font-['Google_Sans_Text'] font-normal text-[14px] leading-[20px] text-[#1B1B1C]">
              <span className="font-medium">Cross-Brand Cannibalization & Synergy:</span> Portfolio Bid Strategies and Account-Level Negative Keywords across their MCC.
            </div>
          </div>
        </div>
      </div>
